    ...
    <div class="w3-container w3-card w3-white w3-margin-bottom w3-animate-right">
        ...
        <asp:UpdatePanel ID="upAvisos" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="w3-row">
<%--                    <asp:Button runat="server" Text="Ver Ejemplo" ID="Ejemplo" CssClass="w3-padding w3-button w3-amber w3-hover-blue w3-round w3-left" OnClick="Ejemplo_Click" CausesValidation="false" />--%>
...
<%--                <asp:AsyncPostBackTrigger ControlID="Ejemplo" EventName="Click" />--%>
