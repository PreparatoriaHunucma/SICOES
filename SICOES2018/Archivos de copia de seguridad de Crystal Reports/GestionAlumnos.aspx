...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="divModalInscripcion" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
    ...
    <div class="w3-row w3-animate-right">
        <asp:UpdatePanel ID="upBotones" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="w3-row">
                    <asp:Button CssClass="w3-button w3-amber w3-hover-blue w3-round" ID="btnAgregarAlumno" runat="server" Text="Pre-Inscribir al alumno" OnClick="btnAgregarAlumno_Click" CausesValidation="false" Style="width: 100%" />
                </div>
